                      ...
                      <div className="flex-grow-1 ms-3">
                        <div className="h2 fw-bold">
                          ...
                          {formik.values.formMiddleName &&
                            ` ${formik.values.formMiddleName.charAt(0)}.`}{" "}
                        ...
                        <div className="d-flex align-items-center">
                          ...
                          <div className="flex-grow-1 ms-3">
                            <div className="fw-bold fs-5 mb-0">
                              {formik.values.formEmailAddress || "Nope"}
                            </div>
              ...
              <CardBody>
                <div className="row g-4 align-items-center">
                  <div className="col-xl-6">
                    ...
                    >
                      <div className="flex-shrink-0">
                        <Icon icon="MonetizationOn" size="3x" color="warning" />
                      </div>
                      <div className="flex-grow-1 ms-3">
            ...
            <Card>
              ...
              <CardBody>
                <p>
                  ...
                  Aenean vitae velit efficitur nulla dignissim commodo nec vitae
                  odio. Proin ut risus metus. Aenean dui lectus, laoreet at
                  ornare et, pellentesque id mauris. Morbi a molestie elit. Nunc
                  eget mi in lectus rutrum venenatis. Duis dapibus porta justo,
                  nec dapibus tellus condimentum ultrices. In hac habitasse
                  platea dictumst. Nulla facilisi. Aenean consequat gravida
                  felis vitae vestibulum. Suspendisse lacinia ex sed tellus
                  imperdiet, ut lacinia odio rutrum.
                </p>
                <p>
                  Pellentesque vel sem bibendum, tristique urna a, lacinia
                  tortor. Suspendisse dapibus lectus id venenatis tincidunt.
                  Proin tempor lorem non arcu rutrum interdum. Cras sit amet
                  ultricies lacus, vitae luctus nunc. Sed commodo hendrerit
                  augue, et aliquet sem commodo in. Pellentesque in diam eros.
                  Sed quis sapien eros. Sed eleifend at arcu vitae sagittis.
                </p>
                <p>
