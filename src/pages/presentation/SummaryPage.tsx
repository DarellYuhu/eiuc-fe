                ...
                <div className="row d-flex align-items-center h-100">
                  ...
                  <div className="col-xl-6">
                    ...
                    <p className="fs-4 mb-5">
                      ...
                      <strong>Reactstrap</strong> logic and new components have
                      been created with <em>Bootstrap 5</em> and you can make
                      changes in them. The usage of all components in the{" "}
                ...
                <div className="row d-flex align-items-center h-100">
                  ...
                  <div className="col-xl-6">
                    ...
                    <p className="fs-4 mb-5">
                      ...
                      customized stories with your teammates. You can also copy
                      the jsx and html outputs and paste them directly into your
                      project.
                    </p>
                    <Button
                      color="storybook"
              ...
              <CardBody className="h-100">
                <div className="row d-flex align-items-center h-100">
                  ...
                  <div className="col-xl-6">
                    ...
                    <p className="fs-4 mb-5">
                      Yes! You will have a lot of fun while dealing with forms,
                      you will get the results you want without contradicting
                      the design of the project. In fact, we have another good
                      news, validation is also included.
                    </p>
                    <div className="row g-4">
                      <div className="col-auto">
                        <Button
