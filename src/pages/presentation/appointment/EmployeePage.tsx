...
const EmployeePage = () => {
  ...
  const userTasks = dummyEventsData.filter(
    (f) => f.assigned.username === data.username,
  );
                      ...
                      <div className="col-12">
                        <div className="d-flex align-items-center">
                          ...
                          <div className="flex-grow-1 ms-3">
                            ...
                            <div className="text-muted">Social name</div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <Dropdown>
                    <DropdownToggle>
                      <Button color="info" icon="Compare" isLight>
                        Compared to{" "}
                        <strong>{Number(dayjs().format("YYYY")) - 1}</strong>.
                      </Button>
                    </DropdownToggle>
