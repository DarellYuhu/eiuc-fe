                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-6">
                        ...
                        >
                          ...
                          <CardBody>
                            <div className="d-flex align-items-center pb-3">
                              <div className="flex-shrink-0">
                                <Icon icon="Extension" size="4x" color="info" />
                              </div>
                              <div className="flex-grow-1 ms-3">
                                <div className="fw-bold fs-3 mb-0">
                                  {data.file}
                      ...
                      <div className="col-12 shadow-3d-container">
                        <Accordion id="faq" shadow="sm">
                          ...
                          >
                            Cras rutrum turpis in nisl rhoncus volutpat. In vel
                            augue commodo, aliquet dolor sit amet, pellentesque
                            diam. Donec in dolor eu metus venenatis rutrum. Nam
                            eu venenatis diam. Praesent vel tortor ornare,
                            aliquet risus eget, elementum nisi. Morbi at
                            faucibus neque, at luctus massa. Morbi convallis
                            urna lacus, id suscipit nibh viverra at. Suspendisse
                            molestie lorem nec nulla tempor pulvinar. Praesent
                            interdum felis et lorem ullamcorper, sit amet mattis
                            sapien imperdiet.
                          </AccordionItem>
                        </Accordion>
                      </div>
                    ...
                    <div className="row g-4">
                        ...
                        <div className="flex-grow-1 ms-3 d-flex justify-content-between align-items-center">
                          <figure className="mb-0">
                            <blockquote className="blockquote">
                              <p>
                                We made a very logical decision to use it in our
                                project. Design quality is very nice.
                              </p>
                            </blockquote>
                      ...
                      <div className="col-12 d-flex align-items-center">
                        ...
                        <div className="flex-grow-1 ms-3 d-flex justify-content-between align-items-center">
                          <figure className="mb-0">
                            <blockquote className="blockquote">
                              <p>
                                We have used another product of the same author
                                before. It was very easy to integrate it into
                                our project.
                              </p>
                            </blockquote>
                            <figcaption className="blockquote-footer mb-0">
                      ...
                      <div className="col-12 d-flex align-items-center">
                        ...
                        <div className="flex-grow-1 ms-3 d-flex justify-content-between align-items-center">
                          <figure className="mb-0">
                            <blockquote className="blockquote">
                              <p>Just the design I was looking for.🎉🎉</p>
                            </blockquote>
                            <figcaption className="blockquote-footer mb-0">
                              {USERS.CHLOE.name} in{" "}
                              <cite title="Company">Company</cite>
