        ...
        <div className="row">
            ...
            <Card>
              ...
              <CardBody>
                <p className="lead">
                  ...
                  your components to be re-rendered with the new state,
                  up-to-date state.
                </p>
                <ul>
                  <li>
          ...
          <div className="col-12">
            <Card>
              ...
              <CardBody>
                <p className="lead">
                  "Animation Hooks" usually interpolate numeric values over
                  time.
                </p>
                <ul>
                  <li>
          ...
          <div className="col-12">
            <Card>
              ...
              <CardBody>
                <p className="lead">
                  "Side-effect Hooks" allow your app trigger various
                  side-effects using browser's API.
                </p>
                <ul>
                  <li>
