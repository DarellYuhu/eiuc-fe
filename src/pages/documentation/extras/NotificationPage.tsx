  ...
  const MESSAGE = (
    <div>
      <p>
        ...
        dapibus orci, non consectetur sem aliquam nec.
      </p>
    </div>
  );
  ...
  return (
    <PageWrapper title={componentPagesMenu.notification.text}>
      <SubHeader>
        <SubHeaderLeft>
          <Breadcrumb
            list={[{ title: "Notification", to: "/notifications" }]}
          />
        </SubHeaderLeft>
      </SubHeader>
      <Page>
          ...
          <div className="col-12">
            <Card>
              ...
              <CardBody>
                ...
                <CommonDesc>
                  We preferred <strong>react-notifications-component</strong>{" "}
                  for notification and ensured compatibility with the theme.If
                  you want to make changes, path{" "}
