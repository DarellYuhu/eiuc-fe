...
const BootstrapVariablesPage = () => {
  ...
  const [starterValue, setStarterValue] = useState<TStarterItems>(
    (localStorage.getItem("facit_docChooseStarter") as TStarterItems) ||
      ...
      <SubHeader>
        <SubHeaderLeft>
          <Breadcrumb
            list={[
              ...
              {
                title:
                  gettingStartedPagesMenu.gettingStarted.subMenu
        ...
        <SubHeaderRight>
          ...
          <Button
            ...
            isLight
            icon={
              gettingStartedPagesMenu.gettingStarted.subMenu.projectStructure
                .icon
            }
                    ...
                    {Object.keys(STARTER_PACKAGES).map((item) => (
                      <Checks
                        ...
                        onChange={(
                          ...
                          setStarterValue(event.target.value as TStarterItems);
                        }}
            ...
            <Card>
              ...
              <CardBody>
                <p>
                  ...
                  modify their values, and remove the <code>!default</code>{" "}
                  flag. If a variable has already been assigned, then it won’t
                  be re-assigned by the default values in Bootstrap.
                </p>
                <p>
                  You will find the complete list of Bootstrap’s variables in
                  the list below. Some variables are set to <code>null</code>,
                  these variables don’t output the property unless they are
