...
const InstallationPage = () => {
  ...
  return (
    <PageWrapper
      title={gettingStartedPagesMenu.gettingStarted.subMenu.installation.text}
    >
      <SubHeader>
        <SubHeaderLeft>
          <Breadcrumb
            list={[
              ...
              {
                title:
                  gettingStartedPagesMenu.gettingStarted.subMenu.installation
                    .text,
        ...
        <div className="row h-100 align-content-start">
          <div className="col-12">
            <Card>
              ...
              <CardBody>
                <p>
                  While explaining these documents, it is assumed that you have
                  a basic knowledge of JS, HTML, CSS and ReactJS. You can learn
                  more about ReactJS at{" "}
                  <a
