                ...
                <Card>
                  ...
                  <CardBody>
                    <p>
                      ...
                      loading and data mutations. Through route nesting, complex
                      application layouts and data dependencies become simple
                      and declarative.
                    </p>
                    <p>
              ...
              <Card>
                <CardHeader>
                  <CardLabel icon="AccountTree" iconColor="success">
                    ...
                    >
                      <CardSubTitle>src/routes/contentRoutes.tsx</CardSubTitle>
                    </Visible>
                  </CardLabel>
                </CardHeader>
                <CardBody>
                ...
                <CardHeader>
                  ...
                  <CardActions>
                    <Button
                      ...
                      icon={viewContentStatus ? "VisibilityOff" : "Visibility"}
                      onClick={() => setViewContentStatus(!viewContentStatus)}
                    >
