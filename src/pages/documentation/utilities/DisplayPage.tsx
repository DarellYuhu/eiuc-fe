        ...
        <div className="row">
            ...
            <Card id="notation" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  ...
                  applied from <code>min-width: 0;</code> and up, and thus are
                  not bound by a media query. The remaining breakpoints,
                ...
                <p>
                  The media queries affect screen widths with the given
                  breakpoint <em>or larger</em>. For example,{" "}
                  <code>.d-lg-none</code> sets <code>display: none;</code> on{" "}
            ...
            <Card id="hiding-elements" className="scroll-margin">
              ...
              <CardBody>
                ...
                <p>
                  ...
                  you can combine one <code>.d-*-none</code> class with a{" "}
                  <code>.d-*-*</code> class, for example{" "}
                  <code>.d-none .d-md-block .d-xl-none .d-xxl-none</code> will
                  hide the element for all screen sizes except on medium and
                  large devices.
                </p>
          ...
          <div className="col-12">
            <Card id="display-in-print" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  Change the <code>display</code> value of elements when
                  printing with our print display utility classes. Includes
                  support for the same <code>display</code> values as our
                  responsive <code>.d-*</code> utilities.
                </p>
                <ul>
                  <li>
