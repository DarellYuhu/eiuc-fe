        ...
        <div className="row">
            ...
            <Card id="enable-flex-behaviors" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  ...
                  <strong>direct children elements</strong> into flex items.
            ...
            <Card id="direction" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  ...
                  class here as the browser default is <code>row</code>.
                  However, you may encounter situations where you needed to
                  explicitly set this value (like responsive layouts).
                </p>
                <p>
                  Use <code>.flex-row</code> to set a horizontal direction (the
                  browser default), or <code>.flex-row-reverse</code> to start
          ...
          <div className="col-12">
            <Card id="justify-content" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  Use <code>justify-content</code> utilities on flexbox
                  containers to change the alignment of flex items on the main
                  axis (the x-axis to start, y-axis if{" "}
          ...
          <div className="col-12">
            <Card id="align-items" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  Use <code>align-items</code> utilities on flexbox containers
                  to change the alignment of flex items on the cross axis (the
          ...
          <div className="col-12">
            <Card id="grow-and-shrink" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  Use <code>.flex-grow-*</code> utilities to toggle a flex
                  item’s ability to grow to fill available space. In the example
                  below, the <code>.flex-grow-1</code> elements uses all
                  available space it can, while allowing the remaining two flex
                ...
                <p>
                  ...
                  item’s ability to shrink if necessary. In the example below,
                  the second flex item with <code>.flex-shrink-1</code> is
                  forced to wrap its contents to a new line, “shrinking” to
                  allow more space for the previous flex item with{" "}
                  <code>.w-100</code>.
                </p>
                ...
                <p>
                  Responsive variations also exist for <code>flex-grow</code>{" "}
                  and <code>flex-shrink</code>.
                </p>
                <ul>
                  <li>
            ...
            <Card id="auto-margins" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  ...
                  alignments with auto margins. Shown below are three examples
                  of controlling flex items via auto margins: default (no auto
            ...
            <Card id="order" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  ...
                  handful of <code>order</code> utilities. We only provide
                  options for making an item first or last, as well as a reset
                  to use the DOM order. As <code>order</code> takes any integer
                  value from 0 to 5, add custom CSS for any additional values
                  needed.
                </p>
                ...
                <p>
                  ...
                  <code>.order-first</code> and <code>.order-last</code> classes
                  that change the <code>order</code> of an element by applying{" "}
                  <code>order: -1</code> and <code>order: 6</code>,
                  respectively.
                </p>
                <ul>
                  <li>
            ...
            <Card id="align-content" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  ...
                  to align flex items <em>together</em> on the cross axis.
                  Choose from <code>start</code> (browser default),{" "}
                  <code>end</code>, <code>center</code>, <code>between</code>,{" "}
                  <code>around</code>, or <code>stretch</code>. To demonstrate
                  these utilities, we’ve enforced <code>flex-wrap: wrap</code>{" "}
                  and increased the number of flex items.
                </p>
                <p>
                  <strong>Heads up!</strong> This property has no effect on
