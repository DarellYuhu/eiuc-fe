            ...
            <Card id="text-alignment" className="scroll-margin">
              ...
              <CardBody>
                ...
                <CommonDesc color="info">
                  ...
                  While, aesthetically, justified text might look more
                  appealing, it does make word-spacing more random and therefore
                  harder to read.
                </CommonDesc>
              </CardBody>
            </Card>
            ...
            <Card id="text-wrapping-and-overflow" className="scroll-margin">
              ...
              <CardBody>
                ...
                <CommonCodePreview code={WRAP_2}>
                  <div
                    className="text-nowrap bg-light"
                    style={{ width: "8rem" }}
                  >
                    This text should overflow the parent.
                  </div>
            ...
            <Card id="font-size" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  ...
                  heading classes (e.g., <code>.h1</code>–<code>.h6</code>)
                  apply <code>font-size</code>, <code>font-weight</code>, and{" "}
                  <code>line-height</code>, these utilities <em>only</em> apply{" "}
                  <code>font-size</code>. Sizing for these utilities matches
                  HTML’s heading elements, so as the number increases, their
                  size decreases.
                </p>
            ...
            <Card id="sass" className="scroll-margin">
              ...
              <CardBody>
                ...
                <Card id="utilities-api" className="scroll-margin rounded-2">
                  ...
                  <CardBody>
                    <p>
                      Font and text utilities are declared in our utilities API
                      in{" "}
