                ...
                <Card id="notation" className="scroll-margin rounded-2">
                  ...
                  <CardBody>
                    <p>
                      ...
                      are not bound by a media query. The remaining breakpoints,
                ...
                >
                  ...
                  <CardBody>
                    <p>
                      ...
                      fixed-width block level content—that is, content that has{" "}
                      <code>display: block</code> and a <code>width</code>{" "}
                      set—by setting the horizontal margins to <code>auto</code>
                      .
                    </p>
            ...
            <Card id="negative-margin" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  ...
                  values (<code>padding</code> cannot). These negative margins
                  are <strong>disabled by default</strong>, but can be enabled
                  in Sass by setting <code>$enable-negative-margins: true</code>
                  .
                </p>
                <p>
            ...
            <Card id="gap" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  ...
                  items (children of a <code>display: grid</code> container).
                  Gap utilities are responsive by default, and are generated via
                  our utilities API, based on the <code>$spacers</code> Sass
                  map.
                </p>
                ...
                <p>
                  Support includes responsive options for all of Bootstrap’s
                  grid breakpoints, as well as six sizes from the{" "}
                  <code>$spacers</code> map (<code>0</code>–<code>5</code>).
                  There is no <code>.gap-auto</code> utility class as it’s
                  effectively the same as <code>.gap-0</code>.
                </p>
              </CardBody>
            </Card>
          </div>
