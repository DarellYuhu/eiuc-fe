        ...
        <div className="row">
            ...
            <Card>
              <CardBody>
                <p>
                  ...
                  via Sass. Our utility API is based on a series of Sass maps
                  and functions for generating families of classes with various
                ...
                <p>
                  ...
                  is later merged with your custom <code>$utilities</code> map,
                  if present. The utility map contains a keyed list of utility
                  groups which accept the following options:
                </p>
                    ...
                    <table className="table text-start mb-0">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            Name of the property, this can be a string or an
                            array of strings (e.g., horizontal paddings or
                            margins).
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            ...
                            name to be the same as the value. If{" "}
                            <code>null</code> is used as map key, it isn’t
                            compiled.
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>Optional</td>
                          <td>
                            Variable for the class name if you don’t want it to
                            be the same as the property. In case you don’t
                            provide the <code>class</code> key and{" "}
                            <code>property</code> key is an array of strings,
                            the class name will be the first element of the{" "}
                            <code>property</code> array.
                          </td>
                        </tr>
                        <tr>
                          <td>
                          ...
                          <td>
                            ...
                            <code>:hover</code> or <code>:focus</code> to
                            generate for the utility. No default value.
                          </td>
                        </tr>
                        <tr>
                          <td>
                          ...
                          <td>Optional</td>
                          <td>
                            Boolean indicating if responsive classes need to be
                            generated. <code>false</code> by default.
                          </td>
                        </tr>
                        <tr>
                          <td>
                          ...
                          <td>Optional</td>
                          <td>
                            Boolean to enable fluid rescaling. Have a look at
                            the{" "}
                            <a
                            ...
                            page to find out how this works. <code>false</code>{" "}
                            by default.
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>Optional</td>
                          <td>
                            Boolean indicating if print classes need to be
                            generated. <code>false</code> by default.
                          </td>
                        </tr>
                        <tr>
                ...
                <Card id="print-utilities" className="scroll-margin rounded-2">
                  ...
                  <CardBody>
                    <p>
                      ...
                      <strong>also</strong> generate utility classes for print,
                      which are only applied within the{" "}
          ...
          <div className="col-12">
            <Card id="using-the-api" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  Now that you’re familiar with how the utilities API works,
                  learn how to add your own custom classes and modify our
                  default utilities.
                </p>
                <Card id="add-utilities" className="scroll-margin rounded-2">
                  ...
                  <CardBody>
                    <p>
                      ...
                      <code>$utilities</code> map with a <code>map-merge</code>.
                      Use the <code>src/styles/utilities/_index.scss</code> file
                      to write new, then use the <code>map-merge</code> to add
                      your additional utilities. For example, here’s how to add
                      a responsive <code>cursor</code> utility with three
                      values.
                    </p>
                    <PrismCode
                      code={ADD_UTILITIES}
                ...
                <Card id="modify-utilities" className="scroll-margin rounded-2">
                  ...
                  <CardBody>
                    <p>
                      ...
                      <code>$utilities</code> map with <code>map-get</code> and{" "}
                      <code>map-merge</code> functions. In the example below,
                      we’re adding an additional value to the <code>width</code>{" "}
                      utilities. Start with an initial <code>map-merge</code>{" "}
                      and then specify which utility you want to modify. From
                      there, fetch the nested <code>"width"</code> map with{" "}
                      <code>map-get</code> to access and modify the utility’s
                      options and values.
                    </p>
                    <PrismCode
                    ...
                    >
                      ...
                      <CardBody>
                        <p>
                          ...
                          convention? The utilities API can be used to override
                          the resulting <code>class</code> of a given
                          utility—for example, to rename <code>.ms-*</code>{" "}
                          utilities to oldish <code>.ml-*</code>:
                        </p>
                        <PrismCode
                ...
                <Card id="remove-utilities" className="scroll-margin rounded-2">
                  ...
                  <CardBody>
                    ...
                    >
                      <CardHeader>
                        <CardLabel>
                          <CardTitle tag="h6">Remove utility in RTL</CardTitle>
                        </CardLabel>
                      </CardHeader>
                      <CardBody>
                        <p>
                          ...
                          , such as line breaks in Arabic. Thus utilities can be
                          dropped from RTL output by setting the{" "}
                        ...
                        <p>
                          ...
                          <a
                            ...
                            rel="noreferrer"
                          >
                            the RTLCSS <code>remove</code> control directive
                          </a>
                          .
                        </p>
                      </CardBody>
