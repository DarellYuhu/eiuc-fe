      ...
      <Page>
        <div className="row">
          <div className="col-12 my-4">
            <h1>Background</h1>
            <p className="lead">
              Convey meaning through <code>background-color</code> and add
              decoration with gradients.
            </p>
          </div>
            ...
            <Card id="sass" className="scroll-margin">
              ...
              <CardBody>
                ...
                <Card id="variables" className="scroll-margin rounded-2">
                  ...
                  <CardBody>
                    <p>
                      Most <code>background-color</code> utilities are generated
                      by our theme colors, reassigned from our generic color
                      palette variables.
                    </p>
                    <CommonCodePreview
                      code={VARIABLES}
                ...
                <Card id="map" className="scroll-margin rounded-2">
                  ...
                  <CardBody>
                    <p>
                      ...
                      over them to generate our utilities, component modifiers,
                      and more.
                    </p>
                    <CommonCodePreview
                      code={MAP}
                ...
                <Card id="mixins" className="scroll-margin rounded-2">
                  ...
                  <CardBody>
                    <p>
                      ...
                      situations where you’d like to create your own gradients.
                    </p>
                    <CommonCodePreview
                      code={MIXIN}
                      language="scss"
