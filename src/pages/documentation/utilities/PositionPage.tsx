            ...
            <Card id="arrange-elements" className="scroll-margin">
              ...
              <CardBody>
                ...
                <CommonCodePreview code={ARRANGE}>
                  <div
                    className={classNames("position-relative", classes.example)}
                  >
                    <div className="position-absolute top-0 start-0" />
                    <div className="position-absolute top-0 end-0" />
                    <div className="position-absolute top-50 start-50" />
            ...
            <Card id="center-elements" className="scroll-margin">
              ...
              <CardBody>
                ...
                <p>
                  ...
                  <code>translateX(-50%)</code> and{" "}
                  <code>translateY(-50%)</code> to the element which, in
                  combination with the edge positioning utilities, allows you to
            ...
            <Card id="examples" className="scroll-margin">
              ...
              <CardBody>
                ...
                <p>
                  ...
                  new ones. Remember that you can extend its functionality by
                  adding entries to the <code>$position-values</code> variable.
                </p>
                <CommonCodePreview>
