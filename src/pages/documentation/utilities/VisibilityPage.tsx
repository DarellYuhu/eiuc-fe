      ...
      <Page>
        <div className="row">
          <div className="col-12 my-4">
            <h1>Visibility</h1>
            <p className="lead">
              Control the visibility of elements, without modifying their
              display, with visibility utilities.
            </p>
          </div>
          ...
          <div className="col-12">
            <Card>
              <CardBody>
                <p>
                  Set the <code>visibility</code> of elements with our
                  visibility utilities. These utility classes do not modify the{" "}
