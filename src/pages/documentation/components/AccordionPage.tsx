                  ...
                  <div className="col-lg-6">
                    <Accordion id="accSample" activeItemId={false}>
                      <AccordionItem
                        ...
                        icon="Person"
                      >
                        Quisque suscipit blandit faucibus. Mauris vel nibh at
                        erat ullamcorper pellentesque. Sed id odio mattis,
                        elementum massa id, placerat purus. Curabitur eu eros
                        velit.
                      </AccordionItem>
                      <AccordionItem
                        id="accor2"
