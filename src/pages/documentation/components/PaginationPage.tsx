...
import Pagination, {
  PaginationItem,
} from "../../../components/bootstrap/Pagination";
        ...
        <div className="row">
          ...
          <div className="col-lg-6">
            <Card stretch>
              ...
              <CardFooter>
                <CommonDesc>
                  You can set <code>isPrev</code> to <code>true</code> and make
                  an icon or write whatever you want.
                </CommonDesc>
              </CardFooter>
            </Card>
          </div>
          <div className="col-lg-6">
            <Card stretch>
              ...
              <CardFooter>
                <CommonDesc>
                  You can set <code>isNext</code> to <code>true</code> and make
                  an icon or write whatever you want.
                </CommonDesc>
              </CardFooter>
            </Card>
