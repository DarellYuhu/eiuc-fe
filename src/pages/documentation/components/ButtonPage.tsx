...
<Button
  ...
  const IS_ACTIVE_STORY = [
    {
      text: "Color Button",
      path: "/docs/components-button-props-isactive--color-button",
    },
    {
      text: "Outline Button",
      path: "/docs/components-button-props-isactive--outline-button",
    },
    {
      text: "Link Button",
      path: "/docs/components-button-props-isactive--link-button",
    },
    {
      text: "Light Button",
      path: "/docs/components-button-props-isactive--light-button",
    },
  ];
  ...
  const IS_DISABLE_STORY = [
    {
      text: "Color Button",
      path: "/docs/components-button-props-isdisable--color-button",
    },
    {
      text: "Outline Button",
      path: "/docs/components-button-props-isdisable--outline-button",
    },
    {
      text: "Link Button",
      path: "/docs/components-button-props-isdisable--link-button",
    },
    {
      text: "Light Button",
      path: "/docs/components-button-props-isdisable--light-button",
    },
  ];
  ...
  const SHADOW_STORY = [
    ...
    {
      text: "Default",
      path: "/docs/components-button-props-shadow--default-or-true",
    },
  ...
  const HOVER_SHADOW_STORY = [
    ...
    {
      text: "Default",
      path: "/docs/components-button-props-hovershadow--default-or-true",
    },
        ...
        <div className="row">
              ...
              <CardBody>
                <div className="row g-4">
                  ...
                  <div className="col-auto">
                    <div className="row g-3 align-items-center">
                      <div className="col-auto">
                        <Button color="danger" isLight size="sm" icon="Archive">
                          Small
                        </Button>
                      </div>
                      <div className="col-auto">
                      ...
                      <div className="col-auto">
                        <Button color="danger" isLight size="lg" icon="Archive">
                          Large
                        </Button>
                      </div>
                    </div>
                  ...
                  <div className="col-auto">
                    <div className="row g-3 align-items-center">
                      <div className="col-auto">
                        <Button color="info" size="lg" icon="Archive" isLight />
                      </div>
                      <div className="col-auto">
                        <Button color="info" icon="Archive" isLight />
                      </div>
                      <div className="col-auto">
                        <Button color="info" size="sm" icon="Archive" isLight />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="col-lg-6">
            <Card stretch>
              ...
              <CardHeader>
                <CommonHowToUse>
                  shadow: PropTypes.oneOf([null, 'none', 'sm', 'default',
                  'lg']),
                </CommonHowToUse>
              </CardHeader>
              <CardBody>
