                      ...
                      >
                        <CardHeader>
                          <CardLabel>
                            <CardTitle>
                              borderSize{" "}
                              <small>{item === null ? "null" : item}</small>
                            </CardTitle>
                            <CardSubTitle>Card</CardSubTitle>
                          </CardLabel>
                        </CardHeader>
            ...
            <Card stretch>
              ...
              <CardBody>
                <p>
                  ...
                  maximus et, auctor at mi. Cras condimentum turpis et ultricies
                  rhoncus. Nunc consectetur dui vitae nisi facilisis lacinia.
                  Proin ultrices vel dui vel rutrum. Donec fringilla mi eu
                  convallis elementum. Donec maximus velit eu scelerisque
                  interdum. Vivamus purus risus, lacinia eu lectus ut, placerat
                  egestas tellus. Cras fermentum dapibus laoreet. Pellentesque
                  eu diam sit amet neque posuere porta. Aenean quis odio eu
                  augue semper consequat quis ut lacus.
                </p>
                <p>
                  ...
                  Curabitur id hendrerit nisi. Vestibulum semper velit et
                  finibus bibendum. Curabitur a nibh suscipit augue convallis
                  ultrices. Quisque ornare magna vel aliquet imperdiet. Cras
                  urna massa, congue sed magna eget, mollis sagittis ante.
                  Praesent dapibus risus feugiat, sodales nisi vel, venenatis
                  turpis. Aliquam nec elit a sem tincidunt sollicitudin.
                </p>
                <p>
                  ...
                  id, cursus fermentum erat. Curabitur maximus ullamcorper
                  metus, ut efficitur orci accumsan a. Nulla eget laoreet
            ...
            <Card stretch="semi">
              ...
              <CardBody>
                <p>
                  ...
                  quis urna eu enim pharetra interdum. Phasellus non porta
                  neque. Nulla non urna venenatis purus rhoncus eleifend ac in
                  diam. Aliquam convallis sit amet metus at accumsan. Lorem
                  ipsum dolor sit amet, consectetur adipiscing elit. Praesent
                  tincidunt augue placerat eros fermentum ullamcorper.
                </p>
              </CardBody>
            </Card>
            <Card stretch="semi">
              ...
              <CardBody>
                <p>
                  ...
                  Morbi viverra, tellus in mattis eleifend, purus purus
                  tincidunt elit, id ultrices erat quam at lorem. Donec feugiat
                  ut arcu fringilla scelerisque. Cras rhoncus velit eu ex
                  pretium, a pharetra tellus ultrices. Nullam id elementum
                  lectus. Aliquam non ex sit amet risus volutpat venenatis.
                  Vivamus tincidunt consectetur nibh, a efficitur enim cursus
                  vel. Praesent libero metus, aliquam ut ultricies a, lobortis
                  ac neque. Vestibulum euismod lobortis lectus at posuere. Etiam
                  tristique diam id mauris dictum euismod. Fusce ac imperdiet
                  neque.
                </p>
              </CardBody>
            </Card>
          ...
          <div className="col-xl-4">
            <Card stretch>
              ...
              <CardBody>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Quisque volutpat sodales purus, nec pharetra turpis imperdiet
                  quis.
                </p>
              </CardBody>
              <CardFooter>
                ...
                <Card hasTab tabButtonColor="info">
                  ...
                  >
                    <Card shadow="none" className="border-0">
                      <CardHeader className="px-0 pt-0">
                        ...
                        <CardActions>
                          <Button color="danger" isLight hoverShadow="default">
                            Button
                          </Button>
                          <ButtonGroup>
                            <Dropdown>
                      ...
                      <CardBody className="px-0">
                        <div className="row">
                          ...
                          <div className="col-md-8">
                            <p>
                              Lorem ipsum dolor sit amet, consectetur adipiscing
                              elit. Nunc ut tempus arcu. Vivamus cursus tortor
                              vel gravida tincidunt. Sed feugiat turpis tellus,
                              et ultricies arcu scelerisque ac. Mauris tortor
                              metus, pulvinar ac leo eget, iaculis consectetur
                              nibh. Mauris fringilla odio at malesuada aliquam.
                  ...
                  >
                    <div className="row">
                      ...
                      <div className="col-md-8">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Nunc ut tempus arcu. Vivamus cursus tortor vel gravida
                        tincidunt. Sed feugiat turpis tellus, et ultricies arcu
                        scelerisque ac. Mauris tortor metus, pulvinar ac leo
                        eget, iaculis consectetur nibh. Mauris fringilla odio at
                        malesuada aliquam. Proin tincidunt enim a luctus
                        egestas.
                      </div>
                    </div>
                  </CardTabItem>
