...
<Popovers
  ...
  const PLACEMENT_STORY = [
    ...
    {
      text: "auto",
      path: "/story/components-popovers-props--placement&args=placement:auto",
    },
    {
      text: "auto-start",
    ...
    {
      text: "top",
      path: "/story/components-popovers-props--placement&args=placement:top",
    },
    {
      text: "top-start",
    ...
    {
      text: "left",
      path: "/story/components-popovers-props--placement&args=placement:left",
    },
    {
      text: "left-start",
        ...
        <div className="row">
            ...
            <Card stretch>
              ...
              <CardBody>
                <div className="row g-4 d-flex align-items-center">
                  ...
                  <div className="col-auto">
                    <Popovers desc="This is a title" trigger="hover">
                      <Icon icon="Assistant" className="h1 mb-0 text-success" />
                    </Popovers>
                  </div>
                </div>
              </CardBody>
                ...
                <div className="row g-4">
                  <div className="col-lg-6">
                    <Card className="mb-0" stretch>
                      ...
                      <CardBody>
                        <Popovers desc="This is a description" trigger="hover">
                          Bring the mouse to see!
                        </Popovers>
                      </CardBody>
                      <CardFooter>
          ...
          <div className="col-xl-6">
            <Card stretch>
              ...
              <CardHeader>
                <CommonHowToUse>
                  flip: PropTypes.arrayOf( PropTypes.oneOf([ 'auto',
                  'auto-start', 'auto-end', 'top', 'top-start', 'top-end',
            ...
            <Card stretch>
              ...
              <CardBody>
                ...
                <p>
                  ...
                  middlewares, that can hook into the lifecycle of Popper, and
                  add additional logic to the positioning operations provided by
                  default by Popper. They effectively "modify" the popper state
                  in some fashion, adding functionality, hence the term
                  "modifiers".
                </p>
              </CardBody>
              <CardFooter>
