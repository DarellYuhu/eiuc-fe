            ...
            <Card stretch>
              ...
              <CardBody>
                ...
                <CommonDesc className="mt-4">
                  You can enter the index number of the element you want to be
                  at the beginning.
                </CommonDesc>
              </CardBody>
            </Card>
          ...
          <div className="col-xl-6">
            <Card stretch>
              ...
              <CardBody>
                ...
                />
                <CommonDesc className="mt-4">
                  If its value is set to true, it can be moved with the arrow
            ...
            <Card stretch>
              ...
              <CardBody>
                ...
                <CommonDesc className="mt-4">
                  ...
                  first item. If its value is set to "true", autoplays the
                  carousel on load.
                </CommonDesc>
              </CardBody>
            </Card>
