        ...
        <div className="row">
            ...
            <Card>
              ...
              <CardFooter>
                <CommonDesc>
                  ...
                  components as you wish, but you should pay attention to
                  htmlFor and id props for a11y. In the second way, it makes
                  your job easier by making them automatically.
                </CommonDesc>
              </CardFooter>
            </Card>
          </div>
            ...
            <Card stretch>
              ...
              <CardBody>
                <p>
                  ...
                  automatically do what is required for the accessibility. You
                  can click on the Storybook link above to review the code
                  structure.
                </p>
                <FormGroup
                  className="mb-3"
            ...
            <Card stretch>
              ...
              <CardBody>
                <p>
                  ...
                  isFloating value to true. You can click on the{" "}
                  <b>Storybook</b> link above to examine the code structure.
                </p>
                <FormGroup
                  className="mb-3"
                  id="exampleFloat"
              ...
              <CardFooter>
                <CommonDesc>
                  When the isFloating value is true, the placeholder cannot
                  work.
                </CommonDesc>
              </CardFooter>
            </Card>
            ...
            <Card stretch>
              ...
              <CardBody>
                <p>
                  ...
                  For <code>{`<Label htmlFor='...'>...</Label>`}</code>, you
                  must write the htmlFor value.You can click on the{" "}
                  <b>Storybook</b> link above to examine the code structure.
                </p>
                <FormGroup className="mb-3">
              ...
              <CardFooter>
                <CommonDesc>
                  ...
                  labels uses the <code>:placeholder-shown</code>{" "}
          ...
          <div className="col-lg-6">
            <Card stretch>
              ...
              <CardFooter>
                <CommonDesc>
                  In this use, it automatically adds the <code>row</code> class
                  to the{" "}
          ...
          >
            ...
            <ModalBody>
              <div className="row g-4">
                ...
                <div className="col-9">
                  {formik.values.exampleColForLabelMail}
                </div>
                <div className="col-3">
                  <b>Password:</b>
                </div>
