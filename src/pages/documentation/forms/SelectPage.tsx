            ...
            <Card>
              ...
              <CardBody>
                <h3 className="text-muted">
                  Customize the native <code>&#60;select&#62;</code>s with
                  custom props and CSS that changes the element’s initial
                  appearance.
                </h3>
              </CardBody>
              <CardHeader>
            ...
            <Card>
                ...
                <div className="row g-4">
                    ...
                    >
                      ...
                      <CardHeader>
                        <CommonHowToUse>
                          ...
                          <div className="ps-3">PropTypes.shape({`{`}</div>
                          <div className="ps-3">
                            <div className="ps-3">
                        ...
                        <div className="row g-4">
                          ...
                          >
                            <Select
                              ...
                              value={formikTwoWay.values.exampleSelectTwoWay}
                            >
                  ...
                  <div className="col-md-4">
                    ...
                    >
                      <CardHeader>
                        <CardLabel icon="Ballot">
                          <CardTitle>value & children {THIRD_WAY}</CardTitle>
                      ...
                      <CardHeader>
                        <CommonHowToUse>
                          <div>children: PropTypes.string.isRequired,</div>
                          <div>
                            value: PropTypes.oneOfType([PropTypes.string,
                            PropTypes.number]),
                          </div>
                        ...
                        <div className="row g-4">
                          ...
                          >
                            <Select
                              ...
                              value={
                                formikThreeWay.values.exampleSelectThreeWay
                              }
                            >
              ...
              <CardFooter>
                <CommonDesc>
                  ...
                  class, .form-select to trigger the custom styles. Custom
                  styles are limited to the <code>&#60;select&#62;</code>’s
              ...
              <CardFooter>
                <CommonDesc>
                  ...
                  <ul>
                    ...
                    <li>
                      For Mac: Hold down the <kbd>command</kbd> button to select
                      multiple options
                    </li>
                  </ul>
                </CommonDesc>
