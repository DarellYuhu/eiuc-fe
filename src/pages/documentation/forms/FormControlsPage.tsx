        ...
        <div className="row">
            ...
            <Card stretch>
              ...
              <CardHeader>
                <CommonHowToUse>
                  ...
                  'color', 'date', 'datetime-local', 'hidden', 'month',
          ...
          <div className="col-lg-6">
            <Card stretch>
              ...
              <CardFooter>
                <CommonDesc>
                  Credit card form is shown as an example. For detailed usage,
                  you can{" "}
                  <a
                ...
                <Card>
                  ...
                  <CardFooter>
                    <CommonDesc>
                      ...
                      components in your form styled as plain text, use the{" "}
                      <code>readOnly="plaintext"</code> props to remove the
                      default form field styling and preserve the correct margin
                      and padding.
                    </CommonDesc>
                  </CardFooter>
                </Card>
              ...
              <CardFooter>
                <CommonDesc>
                  <ul>
                    ...
                    <li>
                      <b>onInput</b> Script to be run when an element gets user
                      input
                    </li>
                    <li>
                    ...
                    <li>
                      <b>onSelect</b> Fires after some text has been selected in
                      an element
                    </li>
                  </ul>
                </CommonDesc>
