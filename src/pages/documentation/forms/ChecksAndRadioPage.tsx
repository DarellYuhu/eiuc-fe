            ...
            <Card>
              ...
              <CardBody>
                <h3 className="text-muted">
                  ...
                  and radios with our completely rewritten checks component.
                </h3>
              </CardBody>
              <CardHeader>
                <CardLabel icon="Assignment">
                      ...
                      <CardBody>
                        <FormGroup>
                          ...
                          <Label>
                            ...
                            row by adding <code>isInline</code>
                          </Label>
                          <ChecksGroup isInline>
                            <Checks
                              ...
                              checked={inlineCheckboxes.values.checkOne}
                            />
                            <Checks
                              type="checkbox"
                              id="inlineCheckTwo"
                              ...
                              name="checkTwo"
                              onChange={inlineCheckboxes.handleChange}
                              checked={inlineCheckboxes.values.checkTwo}
                            />
                            <Checks
                              type="checkbox"
                              id="inlineCheckThree"
                              ...
                              name="checkThree"
                              onChange={inlineCheckboxes.handleChange}
                              checked={inlineCheckboxes.values.checkThree}
                              disabled
                            />
                          </ChecksGroup>
                        </FormGroup>
