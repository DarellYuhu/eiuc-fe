          ...
          <div className="col-12">
            <Card id="global-settings" className="scroll-margin" stretch>
              <CardBody>
                ...
                <p>
                  These styles can be found within <code>_reboot.scss</code>,
                  and the global variables are defined in{" "}
                  <code>_variables.scss</code>. You can write in{" "}
                  <code>src/styles/settings/_index.scss</code>. Make sure to set{" "}
                  <code>$font-size-base</code> in <code>rem</code>.
                </p>
              </CardBody>
            </Card>
          </div>
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    <Card shadow="none" borderSize={1} stretch>
                      <CardBody>
                        <p>
                          <code>.h1</code> through <code>.h6</code> classes are
                          also available, for when you want to match the font
                          styling of a heading but cannot use the associated
                          HTML element.
                        </p>
                        <table className="table">
                          <thead>
            ...
            <Card id="display-headings" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  ...
                  out, consider using a <b>display heading</b>—a larger,
          ...
          <div className="col-12">
            <Card id="inline-text-elements" className="scroll-margin">
              ...
              <CardBody>
                ...
                <p>
                  While not shown above, feel free to use <code>{`<b>`}</code>{" "}
                  and <code>{`<i>`}</code> in HTML5. <code>{`<b>`}</code> is
            ...
            <Card id="abbreviations" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  ...
                  gain a help cursor to provide additional context on hover and
                ...
                <div className="row">
                  <div className="col-lg-6">
                    <Card id="unstyled" stretch className="scroll-margin">
                      ...
                      <CardBody>
                        <p>
                          Remove the default <code>list-style</code> and left
                    ...
                    >
                      ...
                      <CardBody>
                        <p>
                          ...
                          <code>.text-truncate</code> class to truncate the text
                          with an ellipsis.
                        </p>
                            ...
                            <dd className="col-sm-9">
                              <dl className="row">
                                ...
                                <dd className="col-sm-8">
                                  I heard you like definition lists. Let me put
                                  a definition list inside your definition list.
                                </dd>
                              </dl>
                            </dd>
                          </dl>
