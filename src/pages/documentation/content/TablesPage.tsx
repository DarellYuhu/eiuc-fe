        ...
        <div className="row">
            ...
            <Card id="overview" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  ...
                  <code>.table</code> to any <code>{`<table>`}</code>, then
                  extend with our optional modifier classes or custom styles.
                  All table styles are not inherited in Bootstrap, meaning any
          ...
          <div className="col-12">
            <Card id="modern" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  Add the base class .table-modern to any{" "}
                  <code>{`<table>`}</code>.
                </p>
                ...
                <Card id="striped-rows" className="scroll-margin rounded-2">
                  ...
                  <CardBody>
                    ...
                    <div className="row g-4">
                      ...
                      <div className="col-lg-4">
                        <CommonCodePreview code={STRIPED_2} className="mb-0">
                          <ExampleTable className="table-dark table-striped" />
                        </CommonCodePreview>
                      </div>
                      <div className="col-lg-4">
                        <CommonCodePreview code={STRIPED_3} className="mb-0">
                ...
                <Card id="table-head" className="scroll-margin rounded-2">
                  ...
                  <CardBody>
                    <p>
                      ...
                      <code>.table-dark</code> to make <code>{`<thead>`}</code>s
                    ...
                    <div className="row g-4">
                      ...
                      <div className="col-lg-6">
                        <CommonCodePreview code={THEAD_DARK} className="mb-0">
                ...
                <Card id="captions" className="scroll-margin rounded-2">
                  ...
                  <CardBody>
                    <p>
                      ...
                      a table. It helps users with screen readers to find a
                    ...
                    <p>
                      You can also put the <code>{`<caption>`}</code> on the top
            ...
            <Card id="responsive-tables" className="scroll-margin">
              ...
              <CardBody>
                <p>
                  ...
                  wrapping a <code>.table</code> with{" "}
                  <code>.table-responsive</code>. Or, pick a maximum breakpoint
                ...
                >
                  ...
                  <CardBody>
                    <p>
                      ...
                      <code>.table-responsive</code> for horizontally scrolling
                      tables.
                    </p>
                ...
                >
                  ...
                  <CardBody>
                    ...
                    <p>
                      <b>
                        These tables may appear broken until their responsive
                        styles apply at specific viewport widths.
                      </b>
                    </p>
