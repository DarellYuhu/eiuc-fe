      ...
      <Page>
        <div className="row">
          <div className="col-12 my-4">
            <h1>Figures</h1>
            <p className="lead">
              Documentation and examples for displaying related images and text
              with the figure component in Bootstrap.
            </p>
          </div>
            ...
            <Card>
              <CardBody>
                ...
                <p>
                  ...
                  elements. Images in figures have no explicit size, so be sure
                  to add the <code>.figure-caption</code> class to your{" "}
