...
class CarouselContainer extends Component<
  TCarouselContainerProps,
  TCarouselContainerState
> {
  ...
  constructor(
    props: TCarouselContainerProps | Readonly<TCarouselContainerProps>,
  ) {
    super(props);
  ...
  componentDidUpdate(
    prevProps: any,
    prevState: { activeIndex: number | undefined },
  ) {
    // eslint-disable-next-line react/destructuring-assignment
...
export default React.forwardRef<HTMLDivElement, TCarouselContainerProps>(
  (props, ref) => (
